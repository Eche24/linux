...
inode: metadata, permission, last modify access time etc. the file link to inode. inode point to all data about a file.

Hard links point to thesame inode of a file.

eg sharing 5000 pics. huge space , used hard link to two users. after delete still have access to it.
